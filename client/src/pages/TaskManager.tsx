...
export const TaskManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto animate-in">
      {/* 1. Purpose-Built Mobile Task Manager (< md) */}
      <div className="md:hidden">
        <MobileTaskManager
          ...
          onSyncGoogleCalendar={(task) => window.open(getGoogleCalendarUrl(task), '_blank')}
          onExportIcs={downloadIcsFile}
        />
      </div>

      {/* 2. Desktop Task Execution Manager (>= md) - PRESERVED 100% */}
      <div className="hidden md:block space-y-8">
        ...
        {/* Data Table */}
        <div className="card overflow-hidden p-0 border-slate-200 dark:border-slate-800">
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                <tr>
                  ...
                  <th className="p-4">Task / Assignment</th>
                      ...
                      >
                        <td className="p-4 text-center">
                          <button
                            ...
                            className={`h-5 w-5 rounded-md border flex items-center justify-center transition-colors mx-auto ${
                              isCompleted
                        ...
                        <td className="p-4">
                          <div className={`font-semibold text-slate-900 dark:text-slate-100 ${isCompleted ? 'line-through text-slate-400' : ''}`}>
                            {task.title}
                          </div>
                          {task.description && (
                        ...
                        <td className="p-4">
                          <span className="font-medium text-xs text-indigo-500 bg-indigo-50 dark:bg-indigo-950/60 px-2 py-0.5 rounded">
                        ...
                        <td className="p-4">
                          ...
                          <span className={`text-[11px] font-medium block mt-0.5 ${rel.isOverdue ? 'text-red-500' : rel.isUrgent ? 'text-amber-500' : 'text-slate-400'}`}>
                            {rel.label}
                          </span>
                        </td>
                        ...
                        <td className="p-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              onClick={() => window.open(getGoogleCalendarUrl(task), '_blank')}
